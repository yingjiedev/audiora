...
const styles = StyleSheet.create({
    ...
    heroShade: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(10,34,91,0.08)" },
    ...
    quickCard: { flex: 1, aspectRatio: 1, paddingHorizontal: 3, borderRadius: 16, alignItems: "center", justifyContent: "center" },
    quickArtwork: { width: 44, height: 44, marginBottom: 3 },
    quickTitle: { fontSize: 11, lineHeight: 15, fontWeight: "700", textAlign: "center", color: "#27324B" },
    quickSubtitle: { marginTop: 1, fontSize: 9, lineHeight: 12, fontWeight: "500", textAlign: "center", color: "#8792A8" },
    ...
    timingMask: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0, zIndex: 5, justifyContent: "flex-end", backgroundColor: "rgba(12, 22, 46, 0.34)" },
